---
title: "Inference_Coverage"
author: "Marcus Tutert"
date: "18/01/2021"
output: html_document
---
Set up functions from InferLD pckg
```{r setup, include=FALSE}
source("~/Desktop/Oxford_Dphil/InferLD/R/HMM_Functions.R")
source("~/Desktop/Oxford_Dphil/InferLD/R/validation_pipeline_functions.R")
...
Rcpp::sourceCpp("~/Desktop/Oxford_Dphil/InferLD/src/Rcpp_test.cpp")
library(plotly)
library(fabricatr)
```
This code will be used to test the coverage of my genetic simulations (from msprime)
```{r}
